...
impl Component for Frame {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="min-h-screen px-3 bg-ruso-dark md:px-0">
            ...
            <div class="w-full max-w-md md:max-w-2xl lg:max-w-4xl 2xl:max-w-6xl 4xl:max-w-8xl">
                <div class="flex items-center justify-between px-4 py-4 -mx-4 border-b border-gray-200 sm:mx-0 sm:px-0">
                    <h1 class="text-2xl font-extrabold tracking-tight text-gray-100">{ title }</h1>
                    <div class="flex items-center ml-6 space-x-6 sm:space-x-10 sm:ml-10">
                    <a href="https://github.com/0xrusowsky/dev-toolkit" target="_blank" class="text-gray-400 transition-colors duration-200 hover:text-gray-100">
                ...
                <div class="font-mono">
                    <div class="form-control text-sm text-gray-400 pt-10 pb-2 flex justify-end">
                    ...
                    <div class="subpixel-antialiased text-gray-500 bg-ruso-dark_code rounded-md shadow-2xl text-sm">
