        ...
        html! {
            <div class="relative flex w-fit items-center rounded-full">
                ...
                <button onclick={ctx.link().callback(|_| Switch::LightMode)}
                    class="font-medium flex items-center gap-2 px-3 md:pl-3 md:pr-3.5 py-3 md:py-1.5 transition-colors relative z-10 text-gray-900 dark:text-gray-400 dark:hover:scale-110 dark:hover:text-gray-300">
                ...
                <button onclick={ctx.link().callback(|_| Switch::DarkMode)}
                    class="font-medium flex items-center gap-2 px-3 md:pl-3 md:pr-3.5 py-3 md:py-1.5 transition-colors relative z-10 text-gray-500 dark:text-gray-100 hover:scale-110 hover:text-gray-600 dark:hover:scale-100">
