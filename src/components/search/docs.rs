...
pub static SEARCH_ITEMS: &[SearchItemData; 43] = &[
    ...
    SearchItemData {
        ...
        params: Some("checksum(addr: `string`)"),
    ...
    SearchItemData {
        ...
        c_type: CommandType::Function,
        alias: None,
        params: Some("selector(fn_sig: `string`)"),
    ...
    SearchItemData {
        ...
        c_type: CommandType::Function,
        alias: Some("sha3"),
        params: Some("keccak256(input: `string`)"),
    ...
    SearchItemData {
        ...
        params: Some("base64_encode(input: `string`)"),
    ...
    SearchItemData {
        ...
        params: Some("base64_decode(input: `string`)"),
