...
pub static SEARCH_ITEMS: &[SearchItemData; 49] = &[
    ...
    SearchItemData {
        ...
        params: None,
        example: Some("// get amount0 from liquidity\nget_amount0_from_range(44928398530981124971653892, 5317859378, 4295128739, 6178424788)"),
    ...
    SearchItemData {
        ...
        alias: Some("get_amount0, amount0_from_range"),
        params: None,
        example: Some("// get amount1 from liquidity\nget_amount1_from_range(44928398530981124971653892, 5317859378, 4295128739, 6178424788)"),
    ...
    SearchItemData {
        ...
        alias: Some("token0"),
        params: None,
        example: Some("// get smallest address (0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1)\nget_token0('0x9c58bacc331c9aa871afd802db6379a98e80cedb', '0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1')"),
    ...
    SearchItemData {
        ...
        alias: Some("token1"),
        params: None,
        example: Some("// get biggest address (0x9c58bacc331c9aa871afd802db6379a98e80cedb)\nget_token1('0x9c58bacc331c9aa871afd802db6379a98e80cedb', '0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1')"),
    ...
    SearchItemData {
        ...
        params: Some("get_upper_tick_and_sqrt_ratio(liquidity: `uint128`, use_amount0: `uint256`, sqrt_price: `uint160`)"),
        example: None,
        desc: "Computes the tick of a Uniswap V3 pool given a price (ratio between tokens, accounting for its decimals).\n Note that the tick may need to be adjusted basead on the pool's tick spacing.",
    },
